...
export default function AdminSetupPage() {
 ...
 <div className="rounded-3xl border border-slate-200 bg-white/80 p-8 shadow-sm backdrop-blur /70">
 ...
 className="w-full rounded-lg border border-slate-300 bg-white px-4 py-2 text-slate-900 placeholder-slate-400 "
 disabled={loading}
 />
 </div>
 ...
 result.ok
 ? "border border-green-200 bg-green-50 text-green-800 /30 "
 : "border border-red-200 bg-red-50 text-red-800 /30 "
 }`}
 >
