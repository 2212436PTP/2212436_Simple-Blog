...
export function RegisterForm() {
  ...
  return (
    ...
    >
      {error && (
        <div className="bg-red-50 /20 text-red-700 p-4 rounded-lg text-sm border border-red-200 sm:text-base">
          {error}
          {cooldownSeconds > 0 && (
      ...
      {cooldownSeconds > 0 ? (
        <div className="text-center space-y-3 bg-yellow-50 /20 p-4 rounded-lg border border-yellow-200 ">
          ...
          <button
            ...
            className="text-sm text-blue-600 hover:text-blue-500 underline font-semibold"
          >
