    ...
    <div className="mt-6 space-y-5 sm:mt-8 sm:space-y-6">
      {justRegistered && (
        <div className="bg-green-50 /20 border border-green-200 rounded-lg p-4">
          <p className="text-green-700 text-sm font-medium sm:text-base">
      ...
      <div>
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3 px-4 border-2 border-gray-300 rounded-lg shadow-sm text-sm font-semibold text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors sm:text-base"
        >
      ...
      <form onSubmit={handleLogin} className="space-y-4 sm:space-y-5">
        <div>
          ...
          <input
            ...
            required
            className="mt-2 block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
