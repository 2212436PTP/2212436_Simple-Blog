  ...
  return (
    <div className="space-y-10">
      <section className="rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-sm backdrop-blur /70">
        <h2 className="mb-4 text-xl font-bold text-slate-950 ">Người dùng</h2>
            ...
            >
              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
                ...
                <button
                  ...
                  className="w-full sm:w-auto rounded-full border border-blue-200 px-3 py-1 text-xs font-semibold text-blue-600 hover:bg-blue-50 /30 /10"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto rounded-full border border-red-200 px-3 py-1 text-xs font-semibold text-red-600 hover:bg-red-50 /30 /10"
                >
                  Xóa
                </button>
              </div>
      ...
      <section className="rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-sm backdrop-blur /70">
        <h2 className="mb-4 text-xl font-bold text-slate-950 ">Bài viết</h2>
        <div className="space-y-3">
          {posts.map((post) => (
            <div
              key={post.id}
      ...
      <section className="rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-sm backdrop-blur /70">
        <h2 className="mb-4 text-xl font-bold text-slate-950 ">Bình luận</h2>
        <div className="space-y-3">
